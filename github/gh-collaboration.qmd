...
- click on the `Files changed` tab and go through the files and changes
  ...
  * those comments are marked as pending and are not visible to anybody until you click `Finish your review`
  * when done with the review click on the `Finish your review` button on the top right corner of the page: 
