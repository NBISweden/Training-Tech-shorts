...
For the remainder of the tutorial `$PREFIX` will point to a fictive project directory. Adjust it to suit your needs.
...
echo 'export PREFIX=/proj/naiss2026-99-999/software' >> ~/.bashrc
