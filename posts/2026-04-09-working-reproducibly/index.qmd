...
_same_ results. This sounds easy in theory, but is often harder in practise.
...
::: {.callout-tip title="Reprocubility at NBIS"}
...
![](images/reproducibility-overview.png){width=400px fig-align="center"}
...
```
 ...
 - [Documentation @ Tools for Reproducible Research](https://nbisweden.github.io/workshop-reproducible-research/pages/documentation.html)
...
standard used in bioinformatics and software engineering at large.
 ...
 - [GitHub @ RSE Tech Group](https://nbisweden.github.io/Training-Tech-shorts/posts/2024-03-12-github-collaboration/)
 - [GitHub READMEs @ RSE Tech Group](https://nbisweden.github.io/Training-Tech-shorts/posts/2025-03-18-github-readmes/)
...
_you_ prefer. Make a file with your most commonly used Git aliases, explore new
VSCode plugins that could give you cool new editing options, create a GitHub
template repository for your support projects, start a dotfiles repository to
store all your configs in... Your way of working doesn't need to be set in
stone, but can evolve along with you and the new tools that are bound to come
along.
