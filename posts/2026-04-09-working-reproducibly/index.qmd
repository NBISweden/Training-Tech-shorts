...
<table style="border-collapse: collapse; width: 100%; font-family: sans-serif;">
  <tr>
    ...
    <th colspan="2" style="text-align: center; background-color: #77c1ac; border: 1px solid #ddd; padding: 8px;">Data</th>
  </tr>
  <tr>
    <td colspan="2" style="border: none;"></td>
    <td style="text-align: center; background-color: #96cfbf; border: 1px solid #ddd; padding: 8px;">Same</td>
    <td style="text-align: center; background-color: #96cfbf; border: 1px solid #ddd; padding: 8px;">Different</td>
  </tr>
  <tr>
    <th rowspan="2" style="background-color: #77c1ac; border: 1px solid #ddd; padding: 8px;">Code</th>
    <td style="text-align: center; background-color: #96cfbf; border: 1px solid #ddd; padding: 8px;">Same</td>
    <td style="text-align: center; background-color: #b9dfd4; border: 1px solid #ddd; padding: 8px;">Reproducible</td>
    <td style="text-align: center; background-color: #b9dfd4; border: 1px solid #ddd; padding: 8px;">Replicable</td>
  </tr>
  <tr>
    <td style="text-align: center; background-color: #96cfbf; border: 1px solid #ddd; padding: 8px;">Different</td>
    <td style="text-align: center; background-color: #b9dfd4; border: 1px solid #ddd; padding: 8px;">Robust</td>
    <td style="text-align: center; background-color: #b9dfd4; border: 1px solid #ddd; padding: 8px;">Generalisable</td>
  </tr>
</table>
...
You should _organise_ everything related to your project. Stick to one
...
[Quarto](https://quarto.org/), [Jupyter](https://jupyter.org/), and [Marimo](https://marimo.io/) are
...
in a seamless way.
 ...
 - [Marimo via SSH @ RSE Tech Group](https://nbisweden.github.io/Training-Tech-shorts/posts/2025-04-15-ssh-config-intro/#run-marimo-using-pixi)
...
compared to package managers.
 ...
 - [Containers @ Tools for Reproducible Research](https://nbisweden.github.io/workshop-reproducible-research/pages/containers.html)
...
It matters less where you currently are, and more where you want to go. Take one
