...
The settings regarding inline suggestions at the rightmost sidebar chat are a bit confusing, and the default case it to post more or less everything to their API. Here are some settings that should be changed to decrease that risk.
...
When you open a workspace for the first time VSCode will ask you if you trust the author of the files. If you say no, AI features (among other things) will be disabled for file in the workspace.
