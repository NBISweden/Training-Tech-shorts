...
Nextflow is a workflow manager written in Groovy.
...
are published by using the process channels they're emitted in.
...
By default, Nextflow starts from the beginning of a workflow. In order to contine from where you last left off, you
