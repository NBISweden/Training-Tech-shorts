...
Show how to use GitHub Actions to raise the quality of your online
repository.

## Problem

You have a GitHub repository. You want it to have a high quality.
You want to **do** instead of **talk**. You want to show your users
that you care about the quality of your project.

Every commit, however, you wonder:

- Are all the links pointing to a valid website?
- Is my new content spellchecked?
- Is my Markdown style following the recommended style?

## Solution

- Find a GitHub Actions script
- Put it in your `.github/workflows` folder
- Commit
- Watch it in action at the 'Actions' tab

## Example 1: broken link checker

```{.bash filename="check_spelling.yaml"}
Content here
Content here # <1>
Content here
Content here # <2>
...
## Example 2: spellchecker

```{.bash filename="check_links.yaml"}
Content here
```

## Example 3: Markdown style checker
...
```{.bash filename="whatever_you_want.yaml"}
Content here
```

## Example 5: using a schedule

## Finding GHA scripts

- Link to GHA Marketplace
